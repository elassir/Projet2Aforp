...
export default function TerrainsScreenSQL({ navigation }: any) {
  ...
  // Forcer le chargement des terrains au démarrage
  React.useEffect(() => {
    console.log("TerrainsScreenSQL - Chargement initial des terrains");
    refetch();
  }, []);
    ...
    <Layout>
      ...
      >
        <View style={{ padding: 15 }}>
          ...
          </View>          {/* Loading et erreurs */}
          {loading && (
            <View style={{ padding: 20, alignItems: 'center' }}>
              <Text style={{ marginBottom: 10 }}>Chargement des terrains...</Text>
          ...
          {filteredTerrains.map((terrain) => (
            <TouchableOpacity
              ...
              disabled={terrain.terrain_statut !== 'disponible' || !auth.user}
              style={{
                padding: 12,
                marginBottom: 10,
            ...
            >
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>                <View style={{ width: 40, height: 40, justifyContent: 'center', alignItems: 'center' }}>
                  <Text style={{ fontSize: 24 }}>
                    {getSportEmoji(terrain.terrain_type)}
                  </Text>
                </View>

                <View style={{ flex: 1, marginLeft: 10 }}>                  <Text fontWeight="bold" size="lg">
              ...
              {terrain.terrain_statut === 'disponible' && auth.user && (
                <Button
