...
import TerrainsScreenSQL from "../screens/terrains/TerrainsScreenSQL";
...
// Stack principal qui inclut MainTabs et d'autres écrans
const Main = () => {
  const { isDarkmode } = useTheme();
  return (
    <MainStack.Navigator
    ...
    >
      {/* On utilise MainTabs comme écran principal */}
      <MainStack.Screen name="MainTabs" component={MainTabs} />
      
      {/* Écrans accessibles depuis n'importe où */}
      <MainStack.Screen name="TerrainsScreenSQL" component={TerrainsScreenSQL} />
...
export default function NavigationTabsSQL() {
